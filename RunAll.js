var doGet = function (e) {
  ...
  = parsedE;var textRes = <?= homePage + "?func=" + JSON.stringify(currentE.parameter["func"]) + "&args=" + JSON.stringify(currentE.parameter["args"]) ?>;alert("e object updated (check the console). You would now typically send this back to the server.");window.open(JSON.stringify(textRes));}
