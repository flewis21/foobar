var doGet = function (e) {
  ...
  = parsedE;var textRes = globalThis["doGet"].apply(currentE);alert("e object updated (check the console). You would now typically send this back to the server.");return textRes;}
