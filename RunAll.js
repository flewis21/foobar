var doGet = function (e) {
  ...
  = parsedE;var textRes = <?= homePage + "?currentE" ?>;alert("e object updated (check the console). You would now typically send this back to the server.");window.open(JSON.stringify(textRes));}
